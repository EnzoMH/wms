...
class WMSTextExtractor:
    ...
    def __init__(self, papers_dir: str = "../Papers", output_dir: str = "../ProcessedData"):
        ...
        # WMS 특화 용어와 분류
        self.wms_terms = {
            'core_wms': ['warehouse', 'management', 'system', 'WMS', 'inventory', 'storage'],
            'technology': ['automation', 'robotics', 'AGV', 'IoT', 'RFID', 'sensors', 'AI', 'machine learning'],
            'operations': ['picking', 'packing', 'shipping', 'receiving', 'sorting', 'handling'],
            'performance': ['efficiency', 'optimization', 'productivity', 'accuracy', 'throughput', 'KPI'],
            'integration': ['ERP', 'supply chain', 'logistics', 'distribution', 'transportation']
        }
